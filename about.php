...
<body class="<?=$page_info["title"]?>-page">
    <div class="container-fluid">
        ...
        <div class="subpage-content-container">
            ...
            <p class="border-bottom rounded">  This project was created from scratch to demo some PHP and Bootstrap as it seems to be in alot of  
            ...
            as adding an unnessisary loop for the homepage and not expanded / abstracted as much as I might have if this wasn't a 
            very basic demo.
            </div>
